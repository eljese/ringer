...
- any additional allow entry, non-empty `ask` list, unknown permission section, unknown top-level key, unsupported action namespace, missing required deny, symlink, or malformed file is a blocking failure.
